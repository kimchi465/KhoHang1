...
<a href="{{ route('danhsachkho.create') }}" class="btn btn-primary">Thêm kho mới</a>
            ...
            <tr>
                ...
                <td>
                    ...
                    -->
                        ...
                        <a href="{{ route('danhsachkho.edit', ['id' => $k->kho_ma]) }}" class="btn btn-primary pull-left">Sửa</a>
                    ...
                    <form method="post" action="{{ route('danhsachkho.destroy', ['id' => $k->kho_ma]) }}" class="pull-left">
